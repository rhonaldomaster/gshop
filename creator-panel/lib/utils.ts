...
export function getVideoThumbnail(videoUrl: string): string {
  // For now, return a placeholder. In production, this would generate actual thumbnails
  return `https://via.placeholder.com/320x180/667eea/ffffff?text=Video+Thumbnail`
}
