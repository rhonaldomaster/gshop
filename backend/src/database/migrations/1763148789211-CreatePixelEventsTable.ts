...
export class CreatePixelEventsTable1763148789211 implements MigrationInterface {
    name = 'CreatePixelEventsTable1763148789211'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sellers" ADD "rutFileUrl" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "sellers" ADD "comercioFileUrl" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "sellers" ADD "bankName" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "sellers" ADD "bankAccountNumber" character varying`);
        await queryRunner.query(`ALTER TABLE "sellers" ADD "bankAccountHolder" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "sellers" ADD "shippingLocalPrice" numeric(10,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "sellers" ADD "shippingNationalPrice" numeric(10,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "sellers" ADD "shippingFreeEnabled" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "sellers" ADD "shippingFreeMinAmount" numeric(10,2)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."pixel_event_type_old" AS ENUM('page_view', 'product_view', 'add_to_cart', 'purchase', 'custom')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."sellers_documenttype_enum_old" AS ENUM('CC', 'NIT', 'RUT', 'Passport')`);
        ...
        await queryRunner.query(`ALTER TABLE "invoices" DROP COLUMN "orderId"`);
        await queryRunner.query(`ALTER TABLE "invoices" DROP COLUMN "invoiceNumber"`);
        await queryRunner.query(`ALTER TABLE "sellers" DROP COLUMN "shippingFreeMinAmount"`);
        await queryRunner.query(`ALTER TABLE "sellers" DROP COLUMN "shippingFreeEnabled"`);
        await queryRunner.query(`ALTER TABLE "sellers" DROP COLUMN "shippingNationalPrice"`);
        await queryRunner.query(`ALTER TABLE "sellers" DROP COLUMN "shippingLocalPrice"`);
