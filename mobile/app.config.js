...
export default ({ config }) => {
  ...
  return {
    ...
    extra: {
      ...
      API_BASE_URL: process.env.API_BASE_URL || 'https://04dd-2800-484-1785-2b00-a989-cbcc-e27b-f867.ngrok-free.app',
      API_VERSION: process.env.API_VERSION || '/api/v1',
      WEBSOCKET_URL: process.env.WEBSOCKET_URL || 'https://04dd-2800-484-1785-2b00-a989-cbcc-e27b-f867.ngrok-free.app',
