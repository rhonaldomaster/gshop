...
export const ENV: EnvConfig = {
  ...
  // API Configuration
  API_BASE_URL: getEnvVar('API_BASE_URL', __DEV__ ? 'http://192.168.20.85:3000' : 'https://api.gshop.com'),
  API_VERSION: getEnvVar('API_VERSION', '/api/v1'),
  WEBSOCKET_URL: getEnvVar('WEBSOCKET_URL', __DEV__ ? 'http://192.168.20.85:3000' : 'https://api.gshop.com'),
